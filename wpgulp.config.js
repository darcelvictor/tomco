...
module.exports = {
	...
	// Project options.
	projectURL: 'http://tomco2:8888', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	bugReport: 'https://tomco.fr/contact/', // Where can users report bugs.
	lastTranslator: 'Victor Darcel <contact@victordarcel.com>', // Last translator Email ID.
	team: 'Victor Darcel <contact@victordarcel.com>', // Team's Email ID.
